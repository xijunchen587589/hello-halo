...
Halo is an AI workstation powered by frontier Agent technology with a pluggable engine architecture — supporting [Claude Code](https://github.com/anthropics/claude-code), [Codex](https://github.com/openai/codex), and Halo SDK. With a complete product layer totaling over 300,000 lines of code, validated by tens of thousands of users, and running stably in enterprise environments, Halo delivers:
...
### Halo Browser Skill — Why Halo Automation Doesn't Break
...
<a href="https://polar.sh/openkursar">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://polar.sh/embed/sponsors.svg?org=openkursar&darkmode">
    <img src="https://polar.sh/embed/sponsors.svg?org=openkursar" />
  </picture>
</a>
